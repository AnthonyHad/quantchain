...
from _02_performance_metrics_suite.data_utils import load_raw_equity, validate_equity_curve
from _02_performance_metrics_suite.performance_metrics import simple_returns, sharpe_ratio, max_drawdown, plot_drawdown
...
if __name__ == "__main__":
    for asset in ASSETS:
        ...
        plot_drawdown(eq, title=f"{asset.upper()} Drawdown", save_path=f"_01_vector_backtester/{asset}_drawdown.png")
        ...
        plt.savefig(f"_01_vector_backtester/{asset}_equity.png")
        plt.close()
